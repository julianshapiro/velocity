...
// numbers later.
for(var n=e.length,r=[],i=[],o=void 0,a=0;a<n;a++){if(!l(e[a])||!De.test(e[a]))
// We have an incomplete lineup, it will get tried again later...
return;r[a]=c(e[a].match(De)),i[a]=0,
