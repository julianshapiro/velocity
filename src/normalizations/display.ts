 ...
 */
export function display(element: HTMLorSVGElement): string;
export function display(element: HTMLorSVGElement, propertyValue: string): boolean;
export function display(element: HTMLorSVGElement, propertyValue?: string): string | boolean {
