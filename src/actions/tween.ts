...
import {expandProperties, Tween} from "../tweens";
 ...
 *
 */
export function tweenAction(args?: any[], elements?: HTMLorSVGElement[], promiseHandler?: VelocityPromise, action?: string): any {
