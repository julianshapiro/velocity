...
var Velocity = (function(global, window, document, undefined) {
	...
	var Velocity = {
		...
		CSS: {/* Defined below. */} as {[key: string]: any},
	...
	var CSS = Velocity.CSS = {
		...
		Normalizations: {
			...
			} as {[key: string]: ((type, element?, propertyValue?) => string)},
			/*****************************
		...
		getPropertyValue: function(element, property, rootPropertyValue?, forceStyleLookup?: boolean) {
		...
		setPropertyValue: function(element: HTMLElement, property: string, propertyValue: any, rootPropertyValue?, scrollData?) {
	...
	(Velocity as any).animate = animate;
	...
	return Velocity;
})((window.jQuery || (window as any).Zepto || window), window, (window ? window.document : undefined));
/******************
 Known Issues
 ******************/
