 ...
 */
export function fixRange(num: number) {
  return Math.min(Math.max(num, 0), 1);
}

export function A(aA1, aA2) {
  return 1.0 - 3.0 * aA2 + 3.0 * aA1;
}

export function B(aA1, aA2) {
  return 3.0 * aA2 - 6.0 * aA1;
}

export function C(aA1) {
  return 3.0 * aA1;
}

export function calcBezier(aT, aA1, aA2) {
  return ((A(aA1, aA2) * aT + B(aA1, aA2)) * aT + C(aA1)) * aT;
}

export function getSlope(aT, aA1, aA2) {
