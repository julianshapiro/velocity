...
namespace VelocityStatic.CSS {
	 ...
	 */
	function borderColor(element: KnownElements): string;
	function borderColor(element: KnownElements, propertyValue: string): boolean;
	function borderColor(element: KnownElements, propertyValue?: string): string | boolean {
