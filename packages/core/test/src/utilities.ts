...
export function applyStartValues(element: HTMLElement, startValues: Record<string, string>) {
...
export function getTarget(startValues?: Record<string, string>): HTMLDivElement {
