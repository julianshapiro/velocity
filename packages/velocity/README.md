...
**Quickstart**  
`<script src="//cdn.jsdelivr.net/jquery.velocity/0.6.0/jquery.velocity.min.js"></script>`
...
- 0.7.0: Elements receive an `:animating` class while animating. Transforms are removed when they hit 0.
