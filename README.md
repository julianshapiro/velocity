...
**Message from [@kvirani](https://github.com/kvirani) [August 22, 2016]:** Hi folks, I have some exciting news to share. Julian has graciously offered and I have accepted to become the lead maintainer for Velocity. I'm really excited to be working closely with and learning from him in order to transition this project onto my plate. I remember the days when Julian had started working on Velocity (locked away in his apartment), when he first released and announced it and finally its subsequent explosion in growth from 0 to what it is today. I hope to bring that same enthusiasm, energy and skill to it and am honored to be taking it on. Looking forward to working on it along with the rest of the contributors.
